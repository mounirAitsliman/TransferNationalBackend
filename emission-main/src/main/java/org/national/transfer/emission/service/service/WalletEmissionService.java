...
public class WalletEmissionService {
    ...
    public Transfers validateTransaction(String identityNumber, String agentId, String canalId) {
        log.info(LoggingUtils.getStartMessage(identityNumber, agentId, canalId));
        ...
        transfers.setEmissionType(Constants.WALLET_EMISSION_TYPE);
